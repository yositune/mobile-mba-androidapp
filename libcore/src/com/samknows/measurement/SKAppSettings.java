...
//	}
	...
	public boolean isServiceEnabled() {
		return PreferenceManager.getDefaultSharedPreferences(ctx).getBoolean(SKConstants.PREF_SERVICE_ENABLED, true);
	}

	public void setServiceEnabled(boolean enabled) {
		Editor editor = PreferenceManager.getDefaultSharedPreferences(ctx).edit();
		editor.putBoolean(SKConstants.PREF_SERVICE_ENABLED, enabled);
		editor.commit();
	}
