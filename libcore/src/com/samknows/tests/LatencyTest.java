...
public class LatencyTest extends Test {
	...
	private void output() {
		...
		// average
		o.add(Long.toString(((long)(average / 1000))));
		output.put(JSON_RTT_AVG, (long) (average / 1000));
		// minimum
		o.add(Long.toString(minimum / 1000));
		output.put(JSON_RTT_MIN, minimum / 1000);
		// maximum
		o.add(Long.toString(maximum / 1000));
		output.put(JSON_RTT_MAX, maximum /1000);
		// standard deviation
		o.add(Long.toString((long) (stddeviation / 1000)));
		
		output.put(JSON_RTT_STDDEV,(long) (stddeviation / 1000));
		// recvPackets
