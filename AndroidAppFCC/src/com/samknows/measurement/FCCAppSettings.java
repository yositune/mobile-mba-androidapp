...
public class FCCAppSettings extends SKAppSettings {
	private static final String TAG = FCCAppSettings.class.getName();
	...
	private FCCAppSettings(Context c) {
	    super(c);
	...
	public static void create(Context c) {
		SKAppSettings.instance = new FCCAppSettings(c);
	}
	
	public static FCCAppSettings getFCCAppSettingsInstance() {
		return (FCCAppSettings)instance;
	}
