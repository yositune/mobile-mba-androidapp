...
public class SamKnowsGraph {
	...
	private void createChartRendererSeriesAndView(Context context) {
        ...
        multipleSeriesRenderer.setYLabelsPadding(10);
        ...
        mGraphicalView = ChartFactory.getTimeChartView(context, dataset, multipleSeriesRenderer, "dd/MM");
        //mGraphicalView = new TimeChart();
...
//     	     	Log.d(getClass().getName(), "Date["+i+"]=" + format.format(cTheCalendar.getTime()));
			}
...
//				}
				...
				theNewArray.set((int) dayIndex, Double.valueOf(value));
			}
