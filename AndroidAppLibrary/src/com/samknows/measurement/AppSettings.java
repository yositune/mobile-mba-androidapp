...
public class AppSettings {
	...
	private AppSettings(Context c) {
		...
		try {
			...
			data_cap_welcome		= Boolean.parseBoolean(p.getProperty(Constants.PROP_DATA_CAP_WELCOME));
	...
	public boolean isServiceEnabled(){
		...
		if(p.contains(Constants.PREF_SERVICE_ENABLED)){
			ret =  p.getBoolean(Constants.PREF_SERVICE_ENABLED, false);
		}else{
