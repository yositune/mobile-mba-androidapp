...
public class SKPreferenceActivity extends PreferenceActivity{
			...
			public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
				...
				if (key.equals(Constants.PREF_DATA_CAP)) {
				    ...
				    if(value > MAX_VALUE){
				    	...
				    	p.setText(""+MAX_VALUE);
				    	Toast t = Toast.makeText(SKPreferenceActivity.this,getString(R.string.max_data_cap_message)+" "+MAX_VALUE, Toast.LENGTH_SHORT);
				    	t.show();
				    }else if(value < MIN_VALUE){
				    	EditTextPreference p = (EditTextPreference) findPreference(key);
				    	p.setText(""+MIN_VALUE);
				    	Toast t = Toast.makeText(SKPreferenceActivity.this,getString(R.string.min_data_cap_message)+MIN_VALUE, Toast.LENGTH_SHORT);
				    	t.show();
				    }
				}
				updateLabels();
